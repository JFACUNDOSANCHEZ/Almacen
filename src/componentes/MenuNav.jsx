...
export default function MenuNav() {
  ...
  <div className="fixed inset-0 z-50 bg-gradient-to-b from-white/70 to-black/70 translate-x-full md:translate-x-0  md:duration-500 md:static md:bg-none peer-checked:translate-x-0">
    <p className='flex  justify-center border md:hidden text-5xl' onClick={() => document.getElementById('menu').checked = false}> <img className='w-14 p-4' src="https://cdn-icons-png.flaticon.com/512/439/439220.png" alt="" /> </p>
